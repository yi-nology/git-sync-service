  ...
  <div class="page-container">
    ...
    <div class="settings-card">
      <div class="setting-item">
        ...
        <el-switch v-model="settings.incremental"/>
      </div>
      <div class="setting-item">
        <div class="setting-info">
        ...
        <el-switch v-model="settings.distLock"/>
      </div>
      <div class="setting-item">
        <div class="setting-info">
        ...
        <el-input-number v-model="settings.timeout" :min="10" :max="600" style="width: 120px;"/>
      </div>
      <div class="setting-item">
        <div class="setting-info">
        ...
        <el-input-number v-model="settings.maxConcurrent" :min="1" :max="10" style="width: 120px;"/>
      </div>
      <div class="setting-item">
        <div class="setting-info">
        ...
        <el-input-number v-model="settings.retentionDays" :min="1" :max="365" style="width: 120px;"/>
      </div>
    </div>
